...
@synthesize ModelArray, searchArray, sendingIndex, upperView, detailImageScroller, detailView, detailCell, initialScrollerFrame, initialCellFrame, titleString, objectToSend, yCenter, yCenterModel;
...
-(void)pushDetailWithIndexPath:(NSIndexPath *)indexPath
{
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, 0.5 * NSEC_PER_SEC), dispatch_get_main_queue(), ^{
        ...
        dispatch_after(dispatch_time(DISPATCH_TIME_NOW, 1.0 * NSEC_PER_SEC), dispatch_get_main_queue(), ^{
            ...
            [backButton setAction:@selector(revertToSearchTabPage)];
...
- (void) makeAppDelModelArray;
{
    ...
    ModelArray = [[ModelArray filteredArrayUsingPredicate:actualCarPredicate] mutableCopy];
}
